...
>
	<#if !HOME_HERO_STYLE_INCLUDED??>
		...
		<style>
			...
			.home-hero__privacy a {
				color: #ea580c;
				text-decoration: underline;
				transition: color 0.2s;
			}
			
			.home-hero__privacy a:hover {
				color: #c2410c;
			}
	...
	<section class="home-hero" aria-label="Hero">
		<div class="home-hero__text">
			...
			<h1>${_title}<br>y proteger su privacidad</h1>
		...
		<div class="home-hero__visual" aria-hidden="true">
			...
			<img src="${_heroImg}" alt="${_title}" width="430" height="580" class="home-hero__img" />
			<div class="home-hero__card">
				<p>Hola Samuel, tu sistema se encuentra seguro</p>
