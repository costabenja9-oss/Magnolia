[#-------------- ASSIGNMENTS --------------]
[#include "/b-fy-web/templates/macros/languages.ftl"]
[#include "/b-fy-web/templates/macros/navigation.ftl"]
  ...
  <div class="relative mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    ...
    <div class="h-16 lg:h-32 flex items-center justify-between">
      <a href="/" class="hover:transition-opacity hover:opacity-60 duration-700 ease-in-out">
        <img class="w-20" src="${ctx.contextPath}/.resources/b-fy-web/webresources/assets/img/logo-simple-orange.png">
      </a>
