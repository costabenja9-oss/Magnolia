...
var Processor = function () {
    ...
    this.process = function (content, parameters) {
        this._submit(parameters, content, ctx.getPostedForm())
    };
    this._submit = function (parameters, content) {
        this.getCaptcha = function (parameters) {
            var httpClient = HttpClients.createDefault();
            var secret = PropertyUtil.getString(content, "secretKey"); // 'ADD YOUR RECAPTCHA V3 KEY HERE';
            ...
            if (obj.success == true && obj.score > 0.5) {
                ...
                throw new Error("Bot detected!" + " " + obj.success + " " + obj.score);
            }
        };
